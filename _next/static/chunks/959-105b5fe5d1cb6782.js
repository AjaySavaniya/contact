        ...
        8045: function(e, t, i) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                var t = e.src,
                    ...
                    V = d.useMemo((function() {
                        var e = b || U || f.imageConfigDefault,
                ...
                "layout" in F && (F.layout && (H = F.layout), delete F.layout);
                var G = k;
                if ("loader" in F) {
                    if (F.loader) {
                        var T = F.loader;
                ...
                if (function(e) {
                    ...
                    var Q = S(t) ? t.default : t;
                    if (!Q.src) throw new Error("An object should only be passed to the image component src parameter if it comes from a static image import. It must include src. Received ".concat(JSON.stringify(Q)));
                    if (Z = Z || Q.blurDataURL, J = Q.src, (!H || "fill" !== H) && (C = C || Q.height, q = q || Q.width, !Q.height || !Q.width)) throw new Error("An object should only be passed to the image component src parameter if it comes from a static image import. It must include height and width. Received ".concat(JSON.stringify(Q)))
                }
                var K = !h && ("lazy" === z || "undefined" === typeof z);
                ((t = "string" === typeof t ? t : J).startsWith("data:") || t.startsWith("blob:")) && (c = !0, K = !1);
                v.has(t) && (K = !1);
                y && (c = !0);
                var X, Y = o(d.useState(!1), 2),
                    $ = Y[0],
                    ee = Y[1],
                    te = o(g.useIntersection({
                        rootRef: I,
                        rootMargin: _ || "200px",
                        disabled: !K
                    }), 3),
                ...
                var ve;
                0;
                var we = (n(ve = {}, "imagesrcset", ye.srcSet), n(ve, "imagesizes", ye.sizes), ve),
                    ze = d.default.useLayoutEffect,
                    Se = d.useRef(W),
                    Ae = d.useRef(t);
                d.useEffect((function() {
                    Se.current = W
                }), [W]), ze((function() {
                    Ae.current !== t && (oe(), Ae.current = t)
                }), [oe, t]);
                var xe = r({
                    isLazy: K,
                    imgAttributes: ye,
                ...
                return d.default.createElement(d.default.Fragment, null, d.default.createElement("span", {
                    style: re
                }, ce ? d.default.createElement("span", {
                    style: le
                    ...
                    "aria-hidden": !0,
                    src: X
                }) : null) : null, d.default.createElement(E, Object.assign({}, xe))), h ? d.default.createElement(u.default, null, d.default.createElement("link", Object.assign({
            ...
            var z = new Map([
                ["default", function(e) {
                    ...
                    return "".concat(p.normalizePathTrailingSlash(t.path), "?url=").concat(encodeURIComponent(i), "&w=").concat(n, "&q=").concat(o || 75)
                }],
                ["imgix", function(e) {
                    var t = e.config,
                        i = e.src,
                        n = e.width,
                        o = e.quality,
                        a = new URL("".concat(t.path).concat(I(i))),
                        r = a.searchParams;
                    r.set("auto", r.getAll("auto").join(",") || "format"), r.set("fit", r.get("fit") || "max"), r.set("w", r.get("w") || n.toString()), o && r.set("q", o.toString());
                    return a.href
                }],
                ["cloudinary", function(e) {
                    ...
                    return "".concat(t.path).concat(a).concat(I(i))
                }],
                ["akamai", function(e) {
                    var t = e.config,
                        i = e.src,
                        n = e.width;
                    return "".concat(t.path).concat(I(i), "?imwidth=").concat(n)
                }],
                ["custom", function(e) {
                    var t = e.src;
            ...
            var E = function(e) {
                ...
                return g = u ? "lazy" : g, d.default.createElement(d.default.Fragment, null, d.default.createElement("img", Object.assign({}, k, t, {
                    decoding: "async",
                    "data-nimg": o,
                    className: a,
                    style: r({}, l, c),
                    ref: d.useCallback((function(e) {
                        w(e), (null == e ? void 0 : e.complete) && j(e, m, 0, f, b, v)
                    }), [w, m, o, f, b, v]),
                    onLoad: function(e) {
                        j(e.currentTarget, m, 0, f, b, v), z && z(e)
                    },
                    onError: function(e) {
                        "blur" === f && v(!0), S && S(e)
                    }
                })), (u || "blur" === f) && d.default.createElement("noscript", null, d.default.createElement("img", Object.assign({}, k, A({
                    config: p,
                    src: m,
                    unoptimized: h,
                    layout: o,
